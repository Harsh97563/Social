...
function SearchBtn() {
  ...
  return (
    <div className=' relative group w-96 bg-gray-700 focus-within:bg-gray-800 rounded-3xl'>
      <div 
      className='flex items-center justify-center invisible md:visible md:w-96 bg-gray-700 focus-within:bg-gray-800 p-2 rounded-2xl'>
          <Search/>
          <input type="text"
          placeholder='Search..'
